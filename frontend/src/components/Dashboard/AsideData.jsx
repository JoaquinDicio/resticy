...
const AsideData = ({ title, typeIcon, quantity }) => {
  ...
  return (
    <>
      <div
        className={`h-[20vh] md:h-[50%] rounded-lg px-5 flex items-center gap-3 relative overflow-hidden ${backgroundColor} text-${iconColor}`}
      >
        {Icon === AnalyticsIcon && (
          <>
        ...
        <div className={`flex gap-1 items-start justify-center z-20`}>
