...
const TotalCard = () => {
  ...
  return (
    <>
    <div className="text-white flex items-center bg-[var(--yellow-color)] overflow-hidden p-5 h-[17vh] md:h-[auto] rounded-lg relative">
      ...
      <div className="z-20">
      <p className="z-20 text-4xl font-bold mb-2">$500.00</p>
